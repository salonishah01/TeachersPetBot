...
|-------------------------------------------------------------------------------------------------------------------------------------------------------|-----|--------------------------------------------------------------------------------------------------------------|
|Video                                                                                                                                                  |2.5  |2min video of new functionality, showing a significant delta from prior.                                      |
|Workload is spread over the whole team (one team member is often Xtimes more productive than the others...                                             |2.5  |[based on additions and deletions of lines on github                                                        ](https://github.com/ramyasaimullapudi/WolfTrackPlus/pulse/monthly)   |
|                                                                                                                                                       |     |                                                                                                              |
|Number of commits                                                                                                                                      |2  |                                                                                                         |
|Number of commits: by different people                                                                                                                 |2.5  |[in GH                                                                                                     ](https://wolftrackplus.readthedocs.io/en/latest/)    |
|Issues reports: there are many                                                                                                                         |2.5  | https://github.com/ramyasaimullapudi/WolfTrackPlus/issues                                                                                                             |
|Issues are being closed                                                                                                                                |2  |[evidence in GH                                                                                            ](https://github.com/ramyasaimullapudi/WolfTrackPlus/issues?q=is%3Aissue+is%3Aclosed)    |
|DOI badge: exists                                                                                                                                      |2.5  |                                                                                                         |
|Docs: doco generated, format not ugly                                                                                                                  |3    |[in GH                                                                                                  ](https://wolftrackplus.readthedocs.io/en/latest/)       |
|Docs: what: point descriptions of each class/function (in isolation)                                                                                   |2.45 |                                                                                                              |
|Docs: how: for common use cases X,Y,Z mini-tutorials showing worked examples on how to do X,Y,Z                                                        |2.5  |        |
|Docs: why: docs tell a story, motivate the whole thing, deliver a punchline that makes you want to rush out and use the thing                          |2  | https://github.com/ramyasaimullapudi/WolfTrackPlus/blob/main/README.md                                                                                                             |
|Docs: short video, animated, hosted on your repo. That convinces people why they want to work on your code.                                            |2 |  https://github.com/ramyasaimullapudi/WolfTrackPlus/blob/main/README.md                                                                                                            |
|Use of version control tools                                                                                                                           |2.5  |   |
|Use of style checkers                                                                                                                                  |2  |[config files in GH showing your this formatter's config                                                     ](https://github.com/ramyasaimullapudi/WolfTrackPlus/actions/workflows/BlackFormatChecker.yml)  |
|Use of code formatters.                                                                                                                                |3    |[config files iin GH showing this checker's config                                                            ](https://github.com/ramyasaimullapudi/WolfTrackPlus/actions/workflows/BlackFormatChecker.yml) |
|Use of syntax checkers.                                                                                                                                |2.5  |[config files in GH                                                                                         ](https://github.com/ramyasaimullapudi/WolfTrackPlus/actions/workflows/BlackFormatChecker.yml)   |
|Use of code coverage                                                                                                                                   |2  |[config files in GH                                                                             ](https://app.codecov.io/gh/ramyasaimullapudi/WolfTrackPlus)               |
|Other automated analysis tools                                                                                                                         |2  |https://github.com/ramyasaimullapudi/WolfTrackPlus/tree/main/.github/workflows       |
|Test cases exist                                                                                                                                       |2.5  |[https://github.com/ramyasaimullapudi/WolfTrackPlus/tree/main/UnitTesting                           |
|Test cases are routinely executed                                                                                                                      |2  |  github actions are being used to execute the test cases every time a commit happens. </br> https://github.com/ramyasaimullapudi/WolfTrackPlus/actions/workflows/Build%20Status.yml                                                                                                            |
|The files CONTRIBUTING.md lists coding standards and lots of tips on how to extend the system without screwing things up                               |2  |   https://github.com/ramyasaimullapudi/WolfTrackPlus/blob/main/CONTRIBUTING.md                                                                                                           |
|Issues are discussed before they are closed                                                                                                            |2.5  |https://github.com/ramyasaimullapudi/WolfTrackPlus/pull/36 <br>https://github.com/ramyasaimullapudi/WolfTrackPlus/pull/8 <br> https://github.com/ramyasaimullapudi/WolfTrackPlus/issues/6     |
|Chat channel: exists                                                                                                                                   |0    |    |
|Test cases: a large proportion of the issues related to handling failing cases.                                                                        |  2.5   |[If a test case fails, open an issue and fix it                                                          ](https://github.com/ramyasaimullapudi/WolfTrackPlus/issues/43)      |
|Evidence that the whole team is using the same tools: everyone can get to all tools and files                                                          |2  |                                                                                                              |
|Evidence that the whole team is using the same tools (e.g. config files in the repo, updated by lots of different people)                              |2  | Everyone is using black </br>https://github.com/ramyasaimullapudi/WolfTrackPlus/commits/main/.github/workflows                                                                                                             |
...
|Evidence that the members of the team are working across multiple places in the code base                                                              |2  |  https://github.com/ramyasaimullapudi/WolfTrackPlus/commits/main/Controller                                                                                                        |
|Short release cycles                                                                                                                                   |2.5  | https://github.com/ramyasaimullapudi/WolfTrackPlus/releases
