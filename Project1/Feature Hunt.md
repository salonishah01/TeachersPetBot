...
|-------------------------------------------------------------------------------------------------------------------------------------------------------|-----|--------------------------------------------------------------------------------------------------------------|
|Video                                                                                                                                                  |2    |[Video](https://www.youtube.com/watch?v=o80gwSOqjs4)         |
|Workload is spread over the whole team (one team member is often Xtimes more productive than the others...                                             |2    |https://github.com/CSC510-Group-25/feature-hunt/pulse|
|Number of commits                                                                                                                                      |2    |                                                                                                        |
|Number of commits: by different people                                                                                                                 |2    | https://github.com/Ashnayak/feature-hunt/graphs/contributors                                                                                                      |
|Issues reports: there are many                                                                                                                         |2    | https://github.com/CSC510-Group-25/feature-hunt/issues                                                                                                             |
|Issues are being closed                                                                                                                                |2.5  |                                                  |
|DOI badge: exists                                                                                                                                      |2.5  |               |
|Docs: doco generated, format not ugly                                                                                                                  |2.5  |          |
|Docs: what: point descriptions of each class/function (in isolation)                                                                                   |2.5  |   https://github.com/CSC510-Group-25/feature-hunt/blob/group25-improvements/docs/Project2_Class_Function_Documentation.pdf                                                                                                           |
|Docs: how: for common use cases X,Y,Z mini-tutorials showing worked examples on how to do X,Y,Z                                                        |2.5  |   |
|Docs: why: docs tell a story, motivate the whole thing, deliver a punchline that makes you want to rush out and use the thing                          |1.5  | https://github.com/CSC510-Group-25/feature-hunt/blob/main/README.md                                                                                                             |
|Docs: short video, animated, hosted on your repo. That convinces people why they want to work on your code.                                            |2    |  https://github.com/CSC510-Group-25/feature-hunt/blob/main/README.md                                                                                                            |
|Use of version control tools                                                                                                                           |2.5  |    |
|Use of style checkers                                                                                                                                  |2    |c      |
|Use of code formatters.                                                                                                                                |2.5  |package.json, Prettier        |
|Use of syntax checkers.                                                                                                                                |2.5  |Pylint and Codacy       |
|Use of code coverage                                                                                                                                   |2    |https://coveralls.io/github/CSC510-Group-25/feature-hunt?branch=main, https://app.codacy.com/gh/CSC510-Group-25/feature-hunt/dashboard                                                            |
|Other automated analysis tools                                                                                                                         |2    |Codacy, Snyk, Dependabot, CodeQL    |
|Test cases exist                                                                                                                                       |2.5  |[front end tests](https://github.com/CSC510-Group-25/feature-hunt/tree/main/src/__tests__) and [back end tests](https://github.com/CSC510-Group-25/feature-hunt/tree/main/test)     |
|Test cases are routinely executed                                                                                                                      |2    |    Travis, Actions                                                                                                           |
|The files CONTRIBUTING.md lists coding standards and lots of tips on how to extend the system without screwing things up                               |2.5  |  https://github.com/CSC510-Group-25/feature-hunt/blob/main/CONTRIBUTING.md                                                                                                            |
|Issues are discussed before they are closed                                                                                                            |2    |Issues are closed with approved pull requests and discussed over Discord    |
|Chat channel: exists                                                                                                                                   |0    |                           |
|Test cases: a large proportion of the issues related to handling failing cases.                                                                        |2    |https://github.com/CSC510-Group-25/feature-hunt/projects/2                    |
|Evidence that the whole team is using the same tools: everyone can get to all tools and files                                                          |2    |                                                                                                              |
|Evidence that the whole team is using the same tools (e.g. config files in the repo, updated by lots of different people)                              |2    |  package.json, requirements.txt                                                                                                            |
...
|Evidence that the members of the team are working across multiple places in the code base                                                              |2    |  https://github.com/CSC510-Group-25/feature-hunt/branches/active?page=1                                                                                                            |
|Short release cycles                                                                                                                                   |2.5  | https://github.com/CSC510-Group-25/feature-hunt/releases
