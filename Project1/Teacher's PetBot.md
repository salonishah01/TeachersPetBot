...
|---------------------------------------------------------------------------------------------------------------------------------------------------------|-------|----------------------------------------------------------------------------------------------------------------|
| Video                                                                                                                                                   | 2.5   |[Video](https://drive.google.com/file/d/1AN1_ogV7DrMxMMEdWf1HOMlxwH-fbyPm/view?usp=sharing)           |
| Workload is spread over the whole team (one team member is often Xtimes more productive than the others...                                              | 2.5   | [github insights](https://github.com/chandur626/TeachersPetBot/pulse/monthly)   |
| Number of commits                                                                                                                                       | 2   |                                                                                                           |
| Number of commits: by different people                                                                                                                  | 2.5   |[Github Insights](https://github.com/chandur626/TeachersPetBot/pulse/monthly)      |
| Issues reports: there are many                                                                                                                          | 2   |  [Issues](https://github.com/chandur626/TeachersPetBot/issues)                                                                                                              |
| Issues are being closed                                                                                                                                 | 2   | evidence in GH [closed issues](https://github.com/chandur626/TeachersPetBot/issues?q=is%3Aissue+is%3Aclosed)                                                                                             |
| DOI badge: exists                                                                                                                                       | 3     |                                                                                                           |
| Docs: doco generated, format not ugly                                                                                                                   | 2.5   |                                                                                                           |
| Docs: what: point descriptions of each class/function (in isolation)                                                                                    | 2.5   |   [README.md](https://github.com/chandur626/TeachersPetBot#readme) and [/docs folder](https://github.com/chandur626/TeachersPetBot/tree/main/docs)                                                                                                             |
| Docs: how: for common use cases X,Y,Z mini-tutorials showing worked examples on how to do X,Y,Z                                                         | 2  |   |
| Docs: why: docs tell a story, motivate the whole thing, deliver a punchline that makes you want to rush out and use the thing                           | 2   |  [README.md](https://github.com/chandur626/TeachersPetBot#readme)                                                                                                              |
| Docs: short video, animated, hosted on your repo. That convinces people why they want to work on your code.                                             | 2.5   | [README.md](https://github.com/chandur626/TeachersPetBot#readme)                                                                                                                |
| Use of version control tools                                                                                                                            | 2.5   |                    |
| Use of style checkers                                                                                                                                   | 2   |[pylint in workflow](https://github.com/chandur626/TeachersPetBot/blob/main/.github/workflows/test.yml)   |
| Use of code formatters.                                                                                                                                 | 2.5   | [pylint in workflow](https://github.com/chandur626/TeachersPetBot/blob/main/.github/workflows/test.yml)          |
| Use of syntax checkers.                                                                                                                                 | 2.5  | [pylint in workflow](https://github.com/chandur626/TeachersPetBot/blob/main/.github/workflows/test.yml)     |
| Use of code coverage                                                                                                                                    | 2.5   | [Codecov](https://app.codecov.io/gh/chandur626/TeachersPetBot)  |
| Other automated analysis tools                                                                                                                          | 2  |[Github Actions](https://github.com/chandur626/TeachersPetBot/blob/main/.github/workflows/test.yml)           |
| Test cases exist                                                                                                                                        | 2.5   | [Github](https://github.com/chandur626/TeachersPetBot/tree/main/test)           |
| Test cases are routinely executed                                                                                                                       | 2.5   | [Github Actions](https://github.com/chandur626/TeachersPetBot/actions?query=branch%3Amain)                                                                                                               |
| The files CONTRIBUTING.md lists coding standards and lots of tips on how to extend the system without screwing things up                                | 2.5   |   [CONTRIBUTING.md](https://github.com/chandur626/TeachersPetBot/blob/main/CONTRIBUTING.md)                                                                                                              |
| Issues are discussed before they are closed                                                                                                             | 2.5   | [discussions on the issue](https://github.com/chandur626/TeachersPetBot/issues/9)  |
| Chat channel: exists                                                                                                                                    | 0     |   |
| Test cases: a large proportion of the issues related to handling failing cases.                                                                         | 2   |[Tests](https://github.com/chandur626/TeachersPetBot/tree/main/test)        |
| Evidence that the whole team is using the same tools: everyone can get to all tools and files                                                           | 2   |                                                                                                                |
| Evidence that the whole team is using the same tools (e.g. config files in the repo, updated by lots of different people)                               | 2   | github workflow and [requirements.txt](https://github.com/chandur626/TeachersPetBot/blob/main/requirements.txt)                                                                                                               |
...
| Evidence that the members of the team are working across multiple places in the code base                                                               | 2   | [Different commits on same file](https://github.com/chandur626/TeachersPetBot/commits/main/src/bot.py)                                                                                                               |
| Short release cycles                                                                                                                                    | 2.5  | [Github releases](https://github.com/chandur626/TeachersPetBot/releases)
