...
|-------------------------------------------------------------------------------------------------------------------------------------------------------|-----|--------------------------------------------------------------------------------------------------------------|
|Video                                                                                                                                                  |2.5  |[Video](https://github.com/SEProjGrp5/ScheduleBot/tree/main)     |
|Workload is spread over the whole team (one team member is often Xtimes more productive than the others...                                             |2  |https://github.com/SEProjGrp5/ScheduleBot/projects/2        |
|                                                                                                                                                       |     |                                                                                                              |
|Number of commits                                                                                                                                      |2  |                                                                                                         |
|Number of commits: by different people                                                                                                                 |2  |Evidence in [Pulse](https://github.com/SEProjGrp5/slash/pulse) and [Commit History](https://github.com/SEProjGrp5/ScheduleBot/commits/main)                                                                                                         |
|Issues reports: there are many                                                                                                                         |2  | Evidence in [issue history](https://github.com/SEProjGrp5/ScheduleBot/projects/2)                                                                                                             |
|Issues are being closed                                                                                                                                |2.5  |Evidence in [issue history](https://github.com/SEProjGrp5/ScheduleBot/projects/2)                                                                                         |
|DOI badge: exists                                                                                                                                      |2.5  |                                                                                                         |
|Docs: doco generated, format not ugly                                                                                                                  |2.5  |Evidence in [docs](https://github.com/SEProjGrp5/ScheduleBot/tree/main/docs) folder                                                                                                        |
|Docs: what: point descriptions of each class/function (in isolation)                                                                                   |2.5  |   Function description is included in the code for every function with proper docstring mentioning the function objective, input parameters and return parameters. [Function description document](https://github.com/SEProjGrp5/ScheduleBot/blob/main/docs/Function_Description.md) is also created as evidence and used pydoc to create automated descriptions using docstring. Eg: [google.html](https://github.com/SEProjGrp5/ScheduleBot/blob/main/docs/Google.html) and [googleevent.html](https://github.com/SEProjGrp5/ScheduleBot/blob/main/docs/GoogleEvent.html)                                                                                                           |
|Docs: how: for common use cases X,Y,Z mini-tutorials showing worked examples on how to do X,Y,Z                                                        |2.5  |      |
|Docs: why: docs tell a story, motivate the whole thing, deliver a punchline that makes you want to rush out and use the thing                          |2.5  | https://github.com/SEProjGrp5/ScheduleBot#readme                                                                                                             |
|Docs: short video, animated, hosted on your repo. That convinces people why they want to work on your code.                                            |2  | Evidence in [readme.md](https://github.com/SEProjGrp5/ScheduleBot#schedulebot)                                                                                                             |
|Use of version control tools                                                                                                                           |3    |     |
|Use of style checkers                                                                                                                                  |2  |Style checker implementation to check code style : Evidence in [Style checker yml file](https://github.com/SEProjGrp5/ScheduleBot/blob/main/checkers/PycharmStyleSyntax.xml) and badge in readme          |
|Use of code formatters.                                                                                                                                |3    |Evidence in [checker folder](https://github.com/SEProjGrp5/ScheduleBot/tree/main/checkers)  |
|Use of syntax checkers.                                                                                                                                |2.5  | Evidence in [checker folder](https://github.com/SEProjGrp5/ScheduleBot/tree/main/checkers)                                                                            |
|Use of code coverage                                                                                                                                   |2  |Evidence on [code coverage website](https://app.codecov.io/gh/SEProjGrp5/ScheduleBot) and badge added to readme                          |
|Other automated analysis tools                                                                                                                         |2  |Used automation such as travis, code coverage, style checker etc        |
|Test cases exist                                                                                                                                       |2.5  |Test cases can be found in [test](https://github.com/SEProjGrp5/ScheduleBot/tree/main/test) folder  |
|Test cases are routinely executed                                                                                                                      |3    |                                                                                                              |
|The files CONTRIBUTING.md lists coding standards and lots of tips on how to extend the system without screwing things up                               |2.5  |  Contributing.md File                                                                                                            |
|Issues are discussed before they are closed                                                                                                            |2 |Every issue was discussed before they are closed on our chat channel. Discussion summary is also provided. Evidence in [issue history](https://github.com/SEProjGrp5/ScheduleBot/projects/2)   |
|Chat channel: exists                                                                                                                                   |0    |Link or screenshots                                                                                           |
|Test cases: a large proportion of the issues related to handling failing cases.                                                                        |2  |Evidence in [test](https://github.com/SEProjGrp5/slash/blob/main/.github/workflows/workflow.yml) folder   |
|Evidence that the whole team is using the same tools: everyone can get to all tools and files                                                          |2  |                                                                                                              |
|Evidence that the whole team is using the same tools (e.g. config files in the repo, updated by lots of different people)                              |2 |    Evidence in [requirements.txt](https://github.com/SEProjGrp5/ScheduleBot/blob/main/requirements.txt). The whole team has configured their system using the requirements.txt file and are using the same tools as required by the project                                                                                                          |
...
|Evidence that the members of the team are working across multiple places in the code base                                                              |2 | Evidence in [Commit History](https://github.com/SEProjGrp5/ScheduleBot/commits/main)                                                                                                             |
|Short release cycles                                                                                                                                   |2.5  | Evidence in [Pulse](https://github.com/SEProjGrp5/ScheduleBot/pulse) and [Commit History](https://github.com/SEProjGrp5/ScheduleBot/commits/main)
